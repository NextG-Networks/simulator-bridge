...
import subprocess
try:
    import sem  # try normal import first
except ModuleNotFoundError:
    # create a minimal shim so import sem works
    import posix_ipc
    sem = types.SimpleNamespace(Semaphore=posix_ipc.Semaphore, BusyError=posix_ipc.BusyError, O_CREAT=posix_ipc.O_CREAT)
    sys.modules['sem'] = sem
