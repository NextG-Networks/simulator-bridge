...
#ifndef RIC_CONTROL_MESSAGE_V2_H
#define RIC_CONTROL_MESSAGE_V2_H
...
namespace ns3 {
  ...
  class RicControlMessageV2 : public SimpleRefCount<RicControlMessageV2>
  {
  public:
    ...
    RicControlMessageV2(E2AP_PDU_t* pdu);
    ~RicControlMessageV2 ();
